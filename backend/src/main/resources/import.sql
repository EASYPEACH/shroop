...
insert into bank (id, account, name, password) values (2, '00210660701016', '이종민', "$2y$10$c.hfcHgbhl07CdQHk7paGuS3ufujtyFMk9ZZJKx30QI2iaj6kx19.");
...
insert into bank (id, account, name, password) values (7, '01093949697', 'test2', "$2y$10$c.hfcHgbhl07CdQHk7paGuS3ufujtyFMk9ZZJKx30QI2iaj6kx19.");
insert into bank (id, account, name, password) values (8, '01093949698', 'test3', "$2y$10$c.hfcHgbhl07CdQHk7paGuS3ufujtyFMk9ZZJKx30QI2iaj6kx19.");

## admin 비밀번호는 전부 's93949697!'

insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, account,grade_score, profile_img) values (1, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'shroop',  '슈룹', '$2y$10$F26pbdd5v2A3NAplkgh9YujhqcbE7Jto2emEZg516FBwapp0XGKJC', '01093949697', 0, 'ROLE_ADMIN', '2023-04-07 17:45:22', '00293949697003', 70, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, account, grade_score, profile_img) values (2, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'leejongmin',  '밍구', '$2y$10$F26pbdd5v2A3NAplkgh9YujhqcbE7Jto2emEZg516FBwapp0XGKJC', '01050595727', 1000000, 'ROLE_ADMIN', '2023-04-07 17:45:22', '00210660701016',80, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, account, grade_score, profile_img) values (3, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'gontaesic',  '따식', '$2y$10$F26pbdd5v2A3NAplkgh9YujhqcbE7Jto2emEZg516FBwapp0XGKJC', '01085518532', 1000000, 'ROLE_ADMIN', '2023-04-07 17:45:22', '01085518532',90, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, account, grade_score, profile_img) values (4, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'parkjinyoung',  '지녕쿤', '$2y$10$F26pbdd5v2A3NAplkgh9YujhqcbE7Jto2emEZg516FBwapp0XGKJC', '01030831889', 1000000, 'ROLE_ADMIN', '2023-04-07 17:45:22', '01030831889',100, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, account, grade_score, profile_img) values (5, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'parkjiyun',  '갓쥰', '$2y$10$F26pbdd5v2A3NAplkgh9YujhqcbE7Jto2emEZg516FBwapp0XGKJC', '01054834790', 1000000, 'ROLE_ADMIN', '2023-04-07 17:45:22', '01054834790',66, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');

insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, account, grade_score, profile_img) values (6, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'test111111',  'test111111', '$2y$10$tRo6AL3AMRBOXPTfqAFNBO06/2zGMTr5Cvkc5CoS0sjgnovVLCyRu', '01012345671', 100000, 'ROLE_USER', '2023-04-07 17:45:22','01054834792',60, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, grade_score, profile_img) values (7, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'test222222',  'test222222', '$2y$10$nffYvzFk6vBB5J.8HFLjkuoaLmXvrtZ97Ivk4eAjWLXIUjvHc5YAe', '01012345672', 1000, 'ROLE_USER', '2023-04-07 17:45:22', 20, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, grade_score, profile_img) values (8, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'test333333',  'test333333', '$2y$10$xsWyO3tEhyaU79pQcHw.3OPjudF4PYrhtoqD/lKd41RscMTfffz62', '01012345673', 1000, 'ROLE_USER', '2023-04-07 17:45:22', 30, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, grade_score, profile_img) values (9, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'test444444',  'test444444', '$2y$10$JWTEL/Hlz93Q88V8WN7.9Os32EgsrC1vtHsKn/FUJ7CIwRC3ll6eC', '01012345674', 1000, 'ROLE_USER', '2023-04-07 17:45:22', 40, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, grade_score, profile_img) values (10, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'test555555',  'test555555', '$2y$10$k1UDG.quwRFX/L3yFy9Vl.gkVd4V3894gMNkLPdfIFBSgagAoDtGa', '01012345675', 2000, 'ROLE_NOT_AUTH_USER', '2023-04-07 17:45:22', 50, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');
insert into member (id, check_agree, create_date, login_date, login_id, nickname, password ,phone_number, point, role, update_date, grade_score, profile_img) values (11, 1,'2023-04-07 17:45:22','2023-04-07 17:45:22', 'test666666',  'test666666', '$2y$10$D9uSnnxjF.qQJHoxMj5YbO69W5BXfW8MbajGM7X6JoVa5VikUfVC2', '01012345676', 10000, 'ROLE_DELETE', '2023-04-07 17:45:22', 60, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/basicProfile.jpeg');


insert into category(id, name) values(1, '전자제품');
insert into category(id, name) values(2, '가구');
insert into category(id, name) values(3, '의류');
insert into category(id, name) values(4, '티켓');
...
insert into product_img(is_defect, product_img_url, product_id) values(true, 'https://shroop-s3.s3.ap-northeast-2.amazonaws.com/17-4.webp', 9);
